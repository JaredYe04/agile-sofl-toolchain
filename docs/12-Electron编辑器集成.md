...
参考实现：`packages/monaco-demo/scripts/lsp-bridge.mjs`
...
node packages/language-server/scripts/bundle.mjs   # VS Code 用；Electron 可直接 dist/server.js
```
...
| `monaco-demo` + `lsp-bridge.mjs` 手动 smoke | 生产 UI |
...
详见 [08-API与CLI.md](./08-API与CLI.md)、[10-编辑器路线图.md](./10-编辑器路线图.md)、[11-VSCode扩展与LSP.md](./11-VSCode扩展与LSP.md)。
