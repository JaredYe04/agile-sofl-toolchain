...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const lspStatus = /* @__PURE__ */ ref("checking…");
    const errorCount = /* @__PURE__ */ ref(0);
    onMounted(async () => {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("main", _hoisted_1, [
        _cache[2] || (_cache[2] = createBaseVNode("header", null, [
          createBaseVNode("h1", null, "Agile-SOFL Studio"),
          createBaseVNode("p", { class: "subtitle" }, "Electron + Vue shell — FSF blocks / module graph UI TODO")
        ], -1)),
        createBaseVNode("section", _hoisted_2, [
          _cache[0] || (_cache[0] = createBaseVNode("h2", null, "Document model", -1)),
          createBaseVNode("p", null, "Modules: " + toDisplayString(modules.value.join(", ") || "—"), 1),
          createBaseVNode("p", null, "Diagnostics (errors): " + toDisplayString(errorCount.value), 1)
        ]),
        createBaseVNode("section", _hoisted_3, [
          _cache[1] || (_cache[1] = createBaseVNode("h2", null, "LSP (main process)", -1)),
          createBaseVNode("p", null, toDisplayString(lspStatus.value), 1)
        ]),
        _cache[3] || (_cache[3] = createBaseVNode("section", { class: "panel todo" }, [
          createBaseVNode("h2", null, "Planned panels"),
          createBaseVNode("ul", null, [
            createBaseVNode("li", null, "Monaco text editor + LSP client"),
            createBaseVNode("li", null, "FSF form blocks via editor-api"),
            createBaseVNode("li", null, "Module relationship graph")
          ])
        ], -1))
      ]);
    };
